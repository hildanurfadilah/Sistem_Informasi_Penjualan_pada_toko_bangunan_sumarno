...
begin
zqry1.sql.clear;
zqry1.sql.Add('insert into tabel_beli values(null,"'+edt1.Text+'","'+edt2.Text+'","'+edt3.text+'","'+edt4.text+'")');
zqry1.ExecSQL;

zqry1.SQL.Clear;
zqry1.SQL.Add('select * from tabel_beli');
zqry1.Open;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update tabel_beli set supplier_id= "'+edt1.Text+'", tgl_beli= "'+edt2.Text+'", total= "'+edt3.Text+'", bayar= "'+edt4.Text+'" where id ="'+id+'"');
zqry1.ExecSQL;
...
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from tabel_beli where id ="'+id+'"');
zqry1.ExecSQL;
